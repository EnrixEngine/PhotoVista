...
const Icons = {
  ...
  volume: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="11,5 6,9 2,9 2,15 6,15 11,19"/><path d="M15.54 8.46a5 5 0 0 1 0 7.07"/></svg>`,
  messageText: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/><line x1="8" y1="10" x2="16" y2="10"/><line x1="8" y1="14" x2="13" y2="14"/></svg>`,
};
...
class PanoramicViewer {
  ...
  addPin(pin) {
    ...
    const el = document.createElement('div');
    const isText = pin.type === 'text';
    el.className = 'pin-marker' + (pin.isGhost ? ' pin-ghost' : '') + (pin.builderMode ? ' builder-mode' : '') + (isText ? ' pin-text' : '');
